                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your username & password to login</p>
             		...
             		@endif
                  	<form class="row g-3 needs-validation login_from" method="POST" action="">
                  	@csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="remember" value="true" id="auth-remember-check">
